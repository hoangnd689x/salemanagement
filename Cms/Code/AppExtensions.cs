...
namespace Cms.Code
{
    public static class AppExtensions
    {
        ...
        public static List<BaseEntityModel> ConvertToBaseEntityModel(this List<Product> products)
        {
            return products.Select(t => new BaseEntityModel() { Id = t.Id, Name = t.Name }).ToList();
        }

        public static List<BaseEntityModel> ConvertToBaseEntityModel(this List<ProductType> productTypes)
        {
            return productTypes.Select(t => new BaseEntityModel() { Id = t.Id, Name = t.Name }).ToList();
        }

        public static List<BaseEntityModel> ConvertToBaseEntityModel(this List<BaseModel> models)
        {
            return models.Select(t => new BaseEntityModel() { Id = t.Id, Name = t.Name }).ToList();
        }
    }
}
